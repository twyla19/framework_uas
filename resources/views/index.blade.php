...
<body>
            ...
            <div class="row">
                <div class="col-md-10 col-lg-8 mx-auto">
                    <div class="site-heading">
                        <h1>Go Blog</h1><span class="subheading">Bapak lo lont3</span></div>
                </div>
            </div>
        </div>
    </header>
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-lg-8 offset-xl-0">
                <div class="post-preview">
                    <a href="post.php">
                        <h2 class="post-title">Man must explore, and this is exploration at its greatest</h2>
                        <h3 class="post-subtitle">Problems look mighty small from 150 miles up</h3>
                    </a>
                    <p class="post-meta">Posted by&nbsp;<a href="#">Penulis Handal on September 24, 2020</a></p>
                </div>
                <hr>
                <div class="post-preview">
                    <a href="#">
                    ...
                    <p class="post-meta">Posted by&nbsp;<a href="#">Penulis Handal on September 18, 2020</a></p>
                </div>
                <hr>
                <div class="post-preview">
                    <a href="#">
                    ...
                    <p class="post-meta">Posted by&nbsp;<a href="#">Penulis Handal on August 24, 2020</a></p>
                </div>
                <hr>
                <div class="post-preview">
                    <a href="#">
                    ...
                    <p class="post-meta">Posted by&nbsp;<a href="#">Penulis Handal on July 8, 2020</a></p>
                </div>
                <hr>
